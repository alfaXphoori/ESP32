...
| ลำดับ | อุปกรณ์ | จำนวน |
|:---:|---------|:-----:
| 1 | ESP32-S3 DevKit | 1 ชุด |
| 2 | LED | 3 ดวง | 
| 3 | Variable Resistor (VR) | 2 ตัว | 
| 4 | MLX90614 | 1 ตัว | 
| 5 | สายจัมเปอร์ | ตามต้องการ | 
...
### 📝 ส่งงานที่
**🔗 Link ส่งงาน**: [คลิกส่งงาน](https://forms.gle/pNN1qNcChVyVHeQX7)**
- ส่งภายในวันที่ 22/10/2025 เวลา 13.00 ส่งช้าไม่รับตรวจ
- ถ้าผลงานเหมือนกันหรือ จับได้ค่ามีการ copy ทั้งหมดส่ง ติดคนสั่ง 2 คนนั้นเ็น 0 คะแนน
